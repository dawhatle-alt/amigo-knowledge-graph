...
| 2 | EM/Server sample-plan topology steps + [[server-phase-4-control-m-server-upgrade]] | "Upgrade Postgres to 11.5" is stale; checklist says 15.3 | Documented in [[postgres-not-upgraded-in-place]]; inline `[!warning]` callouts on the 5 affected runbook notes |
